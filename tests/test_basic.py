...
def test_score_coverage_ratio_exact_values():
    ...
    # 1 skill matched: score = 1 * 3 = 3
    score = score_single_project(project, ["python"], "Advanced", "Games", "High")
    assert score == pytest.approx(3), f"Expected 3 but got {score}"
...
def test_get_recommendations_returns_results():
    ...
    results = get_recommendations("Python", "Beginner", "Data", "Low")["recommendations"]
...
def test_get_recommendations_max_three():
    ...
    results = get_recommendations("Python, JavaScript, HTML", "Beginner", "Web", "Low")["recommendations"]
...
def test_get_recommendations_no_match_returns_empty():
    ...
    results = get_recommendations("Rust", "Advanced", "Games", "High")["recommendations"]
